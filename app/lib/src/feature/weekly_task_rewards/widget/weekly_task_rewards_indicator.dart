...
class _WeeklyTaskRewardsIndicatorState extends State<WeeklyTaskRewardsIndicator> {
  ...
  void _onStateChanged(
    ...
    WeeklyTaskRewardsController controller,
    WeeklyTaskRewardsState prev,
    WeeklyTaskRewardsState next,
  ) {
  ...
  Widget build(BuildContext context) => PopupMenuButton<void>(
    itemBuilder: (context) => [
      ...
      PopupMenuItem(
        ...
        onTap: () => WeeklyTaskRewardsScope.controller(
          context,
        ).manageWeeklyTaskReward(weeklyTaskRewardModel, TaskRewardsActionEnum.delete),
      ),
    ],
  );
}
